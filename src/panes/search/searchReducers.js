...
export function searchErrorReducer(previous = '', action) {
	if (action.type === 'setSearchError') {
		if (typeof(action.error) === 'string') {
			return action.error;
		}
	} else if (action.type === 'setSearchOptions') {
		if (typeof(action.searchOptions.error) === 'string') {
			return action.searchOptions.error;
		}
	}
